    ...
    <div>
      ...
      <div className="grid lg:grid-cols-1 xl:grid-cols-2 gap-2">
        <div className="relative">
          <Link to={"/portfoliov1/set-design" as Routes}>
            <img
              className=""
        ...
        <div className="relative">
          <Link to={"/portfoliov1/window-installation" as Routes}>
            <img
              className=""
        ...
        <div className="relative">
          <Link to={"/portfoliov1/digital-rendering" as Routes}>
            <img
              className=""
        ...
        <div className="relative">
          <Link to={"/portfoliov1/hand-rendering" as Routes}>
            <img
              className=""
        ...
        <div className="relative">
          <Link to={"/portfoliov1/branding" as Routes}>
            <img
              className=""
        ...
        <div className="relative">
          <Link to={"/portfoliov1/styling" as Routes}>
            <img
              className=""
